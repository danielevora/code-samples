...
namespace FleetManagement {
    ...
    public class FleetService : IFleetService {
        public Fleet GetFleet() {
            Console.WriteLine("Getting Fleet 2");
    ...
    {  
        ...
        private const string VinErrorMessage = "Not a valid VIN";
        private const string VinWrongSizeMessage = "Vin of incorrect length.";
        ...
        {  
            ...
            if (val.Length != 17) {
                result = new ValidationResult(VinWrongSizeMessage);
            }

            if (GetCheckDigit(val) != val[8]) {
                result = new ValidationResult(VinErrorMessage);
            }
